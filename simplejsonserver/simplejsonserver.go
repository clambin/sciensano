...
func (server *Server) initializeHandlers() {
	server.Handlers = map[string]simplejson.Handler{
		...
		"vacc-age-booster2":         &vaccinations.GroupedHandler{Reporter: server.Reporter, Scope: vaccinations.ScopeAge, Type: vaccinations2.TypeBooster2},
		...
		"vacc-region-booster2":      &vaccinations.GroupedHandler{Reporter: server.Reporter, Scope: vaccinations.ScopeRegion, Type: vaccinations2.TypeBooster2},
		...
		"vacc-age-rate-booster2":    &vaccinations.RateHandler{Reporter: server.Reporter, Scope: vaccinations.ScopeAge, Type: vaccinations2.TypeBooster2, Fetcher: server.Demographics},
		...
		"vacc-region-rate-booster2": &vaccinations.RateHandler{Reporter: server.Reporter, Scope: vaccinations.ScopeRegion, Type: vaccinations2.TypeBooster2, Fetcher: server.Demographics},
